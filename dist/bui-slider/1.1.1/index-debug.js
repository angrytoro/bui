define("bui-slider/1.1.1/index-debug", ["bui-common/1.1.6/common-debug","jquery"], function(require, exports, module){

var BUI = require("bui-common/1.1.6/common-debug");
var Slider = BUI.namespace('Slider');

BUI.mix(Slider, {
  Slider: require("bui-slider/1.1.1/src/slider-debug")
});

module.exports = Slider;

});
define("bui-slider/1.1.1/src/slider-debug", ["jquery","bui-common/1.1.6/common-debug"], function(require, exports, module){
/**
 * @fileOverview 滑块
 * @ignore
 */
